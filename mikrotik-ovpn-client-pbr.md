...
```
Please note, if you not see ADS route with your OpenVPN server ip you have forgotten add-default-route=yes in your ovpn-client. That's all! Your Mikrotik Policy Based Routing should now be routed through the your OpenVPN server.